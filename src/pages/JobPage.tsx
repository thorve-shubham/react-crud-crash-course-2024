...
export const JobPage = ({ deleteJob }: any) => {
  //   const [job, setJob] = useState<Job | null>(null);
  //   const [loading, setLoading] = useState(true);
  const { id } = useParams(); //to fetch url parameter from url
...
//using data loader to fetch data from backend - feature of react router
